...
//        if (strcmp(comdata, "++END") == 0)
        if (comdata.compareTo("++END") == 0 || comdata.compareTo("++end") == 0)
      {
        LOG_PRINTFLN("!!!!!");
       
        
           topic = TOPIC_PLAY; strcpy(buf, MSG_END);    bErr = false;  
